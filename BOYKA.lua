...
if text == 'الاصدار ❃' and DevBOYKAW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس ميلآن \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevBOYKAW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنبيه : قبل ان تراسل مطور السورس تأكد انك تحتاج لمساعده مهمه \n\n المطور • @XB0BB ')
    end
if text == 'قناه تحديثات البوت ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'❃∫ [تحديثات البوت](t.me/SORMILAN) \n ❃∫ [قناه السورس](t.me/SORMILAN)')
end
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SORMILAN')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/SORMILAN)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/SORMILAN)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, " اللي غير اسمه اهو ["..BOYKAChengName..']')
...
local Text = {
'حذفت معرفك ليه هما حطوه في قناة فضايح😂☹',
"غيرت معرفك ليه هي هددتك☹😂",
...
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكل البت بتغير عليه😂☹")
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SORMILAN')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SORMILAN')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات ميلآن\n ❃∫ ملفات السورس ↓\n≪━━━━━━ML━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━ML━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس ميلآن ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/SORMILAN) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس ميلآن \n") 
end
return false
end
...
local UserName = (b.username_ or "SORMILAN")
